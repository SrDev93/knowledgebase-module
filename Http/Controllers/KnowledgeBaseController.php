...
class KnowledgeBaseController extends Controller
{
    ...
    {
        if (Auth::user()->brand_id) {
            $categories = KnowledgeBaseCategory::whereNotNull('parent_id')->where('brand_id', Auth::user()->brand_id)->get();
        }else {
            $categories = KnowledgeBaseCategory::whereNotNull('parent_id')->get();
        }
